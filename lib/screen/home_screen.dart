...
final feedDataList = [
  ...
  FeedData(userName: 'User2', likeCount: 60, content: '오늘 점심은 맛있었다.'),
  FeedData(userName: 'User3', likeCount: 80, content: '오늘 점심은 맛있었다.'),
  FeedData(userName: 'User4', likeCount: 40, content: '오늘 점심은 맛있었다.'),
  FeedData(userName: 'User5', likeCount: 10, content: '오늘 점심은 맛있었다.'),
  FeedData(userName: 'User6', likeCount: 20, content: '오늘 점심은 맛있었다.'),
];
